...
class ImageUpload extends React.Component<{restaurant: RestaurantModel}, { imageFile: any, successfulUpload: number, selectedMeal: selectionType}>{
    ...
    constructor(props: any) {
        super(props);
        this.state = {imageFile: '', successfulUpload: 0, selectedMeal: {mealIdx: -1, dishIdx: -1}};
